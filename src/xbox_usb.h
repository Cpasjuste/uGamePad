...
#ifndef USBH_GAMEPAD_XBOX_USB_H
#define USBH_GAMEPAD_XBOX_USB_H
...
public:
     ...
     * @return          0 on success.
     */
    uint32_t Init(uint32_t parent, uint32_t port, uint32_t low_speed) override;
     ...
     */
    void attachOnInit(void (*funcOnInit)()) {
...
private:
    ...
    void (*pFuncOnInit)(); // Pointer to function called in onInit()
